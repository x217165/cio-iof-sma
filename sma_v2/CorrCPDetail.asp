    ...
    <script type="text/javascript">
        ...
        function iFrame_display(){
            ...
            function iframe1_display(){
                document.frames("aifr2").document.location.href = 'CorrUsageList.asp?ServiceTypeID=' + intServTypeID;
        ...
        function iframe2_display(){
            document.frames("aifr3").document.location.href = 'CorrSOInstList.asp?ServiceTypeID=' + intServTypeID + '&CustomerServiceID=' + intCustServID;
        }

        function iframe3_display(){
            document.frames("waifr3").document.location.href = 'CorrSOWInstList.asp?ServiceTypeID=' + intServTypeID + '&CustomerServiceID=' + intCustServID;
        }

        function iframe4_display()
        {
            //called whenever a refresh of the iframe is needed
            document.frames("aifrvpnws1").document.location.href = 'CustServVpnList.asp?CustomerServiceID=' + intCustServID;
            ;
        }
...
<body onload="body_onLoad();" onbeforeunload="body_onBeforeUnload();">
    <form name="frmCorrDetail" action="CorrDetail.asp" method="post">
        ...
        <table border="0" width="100%" cols="3">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <input disabled name="txtSLA" style="width: 100%" value="<%=routineHTMLString(rscustServ("SERVICE_LEVEL_AGREEMENT_DESC"))%>"></td>
                </tr>
                <tr>
                    <td align="right">Support Group&nbsp;<font color="red">*</font></td>
                    <td>
                        <select <%=strDisable%> name="selSupportGroup" onchange="fct_onChange()">
                            <option></option>
                ...
                <tr>
                    ...
                    <td>
                        <select <%=strDisable%> onchange="fct_onChange()" name="selStatus">
                ...
                <tr>
                    ...
                    <td align="left">
                        <select <%=strDisable%> name="selmonth" size="1" onchange="fct_onChange();">
                            <option></option>
                            <%
					dim k
 					for k = 1 to 12
					...
					next
                        ...
                        <select <%=strDisable%> name="selday" size="1" onchange="fct_onChange();">
                            <option></option>
                            <%
					for k = 1 to 31
						Response.Write "<option "
					...
					next
                        ...
                        <select <%=strDisable%> name="selyear" size="1" onchange="fct_onChange();">
                            <option></option>
                            <%
					for k = 1990 to 2050
						Response.Write "<option "
					...
					next
                        ...
                        <input <%=strDisable%> type="button" value="..." name="btnCalendar" onclick="return btnCalendar_onclick(1)">
                    </td>
                </tr>
                <tr>
                    <td align="right">Date In Service&nbsp; </td>
                    <td>
                        <select <%=strDisable%> name="selmonth2" size="1" onchange="fct_onChange();">
                            <option></option>
                            <%
 					for k = 1 to 12
						Response.Write "<option "
					...
					next
                        ...
                        <select <%=strDisable%> name="selday2" size="1" onchange="fct_onChange();">
                            <option></option>
                            <%
					for k = 1 to 31
						Response.Write "<option "
					...
					next
                        ...
                        <select <%=strDisable%> name="selyear2" size="1" onchange="fct_onChange();">
                            <option></option>
                            <%
					for k = 1990 to 2050
						Response.Write "<option "
					...
					next
                        ...
                        <input <%=strDisable%> type="button" value="..." name="btnCalendar" onclick="return btnCalendar_onclick(2)">
                        &nbsp;&nbsp;<input <%=strDisable%> type="checkbox" onclick="fct_onChange()" name="chkCreateService" <%if rscustServ("CREATE_SERVICE_TAG_FLAG")="Y" then response.write "checked"%>>
                        Create Service Tag
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <select <%=strDisable%> name="selmonth3" size="1" onchange="fct_onChange();">
                            <option></option>
                            <%
 					for k = 1 to 12
						Response.Write "<option "
					...
					next
                        ...
                        <select <%=strDisable%> name="selday3" size="1" onchange="fct_onChange();">
                            <option></option>
                            <%
					for k = 1 to 31
						Response.Write "<option "
					...
					next
                        ...
                        <select <%=strDisable%> name="selyear3" size="1" onchange="fct_onChange();">
                            <option></option>
                            <%
					for k = 1990 to 2050
						Response.Write "<option "
					...
					next
                        ...
                        <input type="button" value="..." name="btnCalendar" onclick="return btnCalendar_onclick(3)" <%=strDisable%>>
                        &nbsp;&nbsp;<input <%=strDisable%> type="checkbox" onclick="fct_onChange()" name="chkDependency" <%if rscustServ("CHECK_SERVICE_DEPENDENCY_FLAG")="Y" then response.write "checked"%>>
                        Check Service Dep
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <textarea <%=strDisable%> onchange="fct_onChange()" name="txtComment" style="width: 100%"><%=routineHTMLString(rscustServ("COMMENTS"))%></textarea></td>
			...
			%>
                ...
                <table>
                    <thead>
                        <tr>
                            <td align="left" colspan="6">VPN Info</td>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td colspan="6">
                                <iframe id="aifrvpnws1" width="100%" height="100" src="" scrolling="yes" marginheight="1" marginwidth="1"></iframe>
                                <br>
                        </tr>
                    </tbody>
                </table>
		...
		<tbody>
			...
			<input <%=strDisable%> name="btnSave" type="button" style="width: 2cm" value="Save" onclick="return fct_onSave();">&nbsp;&nbsp;
                    </td>
                </tr>
            </tfoot>
        </table>
