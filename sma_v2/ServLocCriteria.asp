...
function window_onLoad() {
	...
	if (strWinName == "Popup" && ((strServLocName != "")||(strCustomerName != "")||(strAddressID != "")||(strCityName != ""))){
		SetCookie("ServLocName",document.frmServLocCriteria.txtServiceLocationName.value);
		SetCookie("AddressID",document.frmServLocCriteria.hdnAddressID.value);
		SetCookie("CustomerName",document.frmServLocCriteria.txtCustomerName.value);
		SetCookie("CityName",document.frmServLocCriteria.txtCity.value);
