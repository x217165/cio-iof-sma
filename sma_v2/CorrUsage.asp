...
<TABLE border=1 cellspacing=0 cellpadding=2 width="100%">
	...
	<tbody>
		...
		if strCustServID <> "" then
			...
			%>
					<td nowrap onClick="cell_onClick('<%=objRsServiceOrderInfo("UPDATE_DATE_TIME")%>',<%=strCustServID%>, <%=objRsServiceOrderInfo("CUSTOMER_SERVICE_CONTACT_ID")%>);"><%=routineHTMLString(objRsServiceOrderInfo("cust_serv_contact_type_lcode"))%>&nbsp;</td>
					<td nowrap onClick="cell_onClick('<%=objRsServiceOrderInfo("UPDATE_DATE_TIME")%>',<%=strCustServID%>, <%=objRsServiceOrderInfo("CUSTOMER_SERVICE_CONTACT_ID")%>);"><%=routineHTMLString(objRsServiceOrderInfo("cust_serv_contact_type_desc"))%>&nbsp;</td>
					<td nowrap onClick="cell_onClick('<%=objRsServiceOrderInfo("UPDATE_DATE_TIME")%>',<%=strCustServID%>, <%=objRsServiceOrderInfo("CUSTOMER_SERVICE_CONTACT_ID")%>);"><%=routineHTMLString(objRsServiceOrderInfo("contact_priority"))%>&nbsp;</td>
					<td nowrap onClick="cell_onClick('<%=objRsServiceOrderInfo("UPDATE_DATE_TIME")%>',<%=strCustServID%>, <%=objRsServiceOrderInfo("CUSTOMER_SERVICE_CONTACT_ID")%>);"><%=routineHTMLString(objRsServiceOrderInfo("contact_name"))%>&nbsp;</td>
					<td nowrap onClick="cell_onClick('<%=objRsServiceOrderInfo("UPDATE_DATE_TIME")%>',<%=strCustServID%>, <%=objRsServiceOrderInfo("CUSTOMER_SERVICE_CONTACT_ID")%>);"><%=routineHTMLString(strWP)%>&nbsp;</td>
					<td nowrap onClick="cell_onClick('<%=objRsServiceOrderInfo("UPDATE_DATE_TIME")%>',<%=strCustServID%>, <%=objRsServiceOrderInfo("CUSTOMER_SERVICE_CONTACT_ID")%>);"><%=routineHTMLString(objRsServiceOrderInfo("work_number_ext"))%>&nbsp;</td>
					<td nowrap onClick="cell_onClick('<%=objRsServiceOrderInfo("UPDATE_DATE_TIME")%>',<%=strCustServID%>, <%=objRsServiceOrderInfo("CUSTOMER_SERVICE_CONTACT_ID")%>);"><%=routineHTMLString(strCP)%>&nbsp;</td>
					<td nowrap onClick="cell_onClick('<%=objRsServiceOrderInfo("UPDATE_DATE_TIME")%>',<%=strCustServID%>, <%=objRsServiceOrderInfo("CUSTOMER_SERVICE_CONTACT_ID")%>);"><%=routineHTMLString(strPP)%>&nbsp;</td>
					<td nowrap onClick="cell_onClick('<%=objRsServiceOrderInfo("UPDATE_DATE_TIME")%>',<%=strCustServID%>, <%=objRsServiceOrderInfo("CUSTOMER_SERVICE_CONTACT_ID")%>);"><%=routineHTMLString(strFP)%>&nbsp;</td>
					<td nowrap onClick="cell_onClick('<%=objRsServiceOrderInfo("UPDATE_DATE_TIME")%>',<%=strCustServID%>, <%=objRsServiceOrderInfo("CUSTOMER_SERVICE_CONTACT_ID")%>);"><%=routineHTMLString(objRsServiceOrderInfo("email_address"))%>&nbsp;</td>
				</tr>
			<%
