...
<!--
*********************************************************************************************
* Page name:	CustCPCriteria.asp                                                          *
* Purpose:		To dynamically set the criteria to search for a customer with               * 
*				customer profile information							                    *
*				Results are displayed via CustCPList.asp                                    *
*                                                                                           *
* Created by:	Nancy Mooney	08/01/2000  (CustCriteria.asp)								*
* 				Anthony Cheung  May 20, 2013   (CustCPCriteria.asp)                         *
...
<%
	...
	dim strCustomerName, strWinName,strServiceEnd, strCustomerProfileName, strCustomerProfileID
...
function btnClear_onclick() {
	...
	document.frmCustCriteria.txtCustomerProfileName.value = "" ;
	document.frmCustCriteria.txtCustomerProfileID.value = "" ;
...
function fct_lookupCustomerProfile(Cust){
	...
	var strCustomerProfileName = document.frmCustCriteria.txtCustomerProfileName.value;
...
<FORM name = frmCustCriteria method=post action="CustCPList.asp" target="fraResult" onSubmit="return validate(this);" >
...
<TABLE border="0" width="100%">    
	...
	<tbody>	
		<TR>
			...
			<TD align=left width=30%><INPUT name=txtCustomerName size=40 maxlength=50 tabindex=1 value="<%=routineHTMLString(strCustomerName)%>"></TD>
		...
		<TR>
			...
			<TD align=left width=30%><INPUT name=txtCustomerProfileName size=40 style="color:silver;" readonly maxlength=50 tabindex=1 value="<%=routineHTMLString(strCustomerProfileName)%>"><INPUT  name=btnCustomerProfileLookup type=button value=... LANGUAGE=javascript onclick="fct_lookupCustomerProfile('A')"></TD>
