...
<!--
********************************************************************************************
* Page name:	ModelCriteria.asp
* Purpose:		To dynamically set the criteria to search for an asset model.
*				Results are displayed via ModelList.asp
*
...
<%
const LIST_PAGE   = "ModelList.asp"
const DETAIL_PAGE = "ModelDetail.asp"

'check user's rights
dim intAccessLevel
intAccessLevel = CInt(CheckLogon(strConst_AssetCatalogue))
if (intAccessLevel and intConst_Access_ReadOnly) <> intConst_Access_ReadOnly then
	DisplayError "BACK", "", 0, "ACCESS DENIED", "You don't have access to asset models. Please contact your system administrator."
end if
%>
<HTML>
<HEAD>
...
function fct_onLoad()
{
 		...
 		{
			SetCookie("ModelDesc",document.frmSearch.txtDesc.value);
...
<tbody>
	<thead><tr><td colspan=4>Model Search</td></tr></thead>
  <tr>
    <td width=15% align=right>Model</td>
    <td width= 20% align=left><INPUT type="text" name="txtDesc" value="<%=Request.Cookies("ModelDesc")%>"></td>
    <td width=15%>&nbsp</td>
    <td>&nbsp</td>
  </tr>
  <tr>
