...
try
		{window.parent.PageTitle.value = "SMA - Managed Correlation"}
	...
	<tbody>
		...
		<tr>
			...
			<td>
				...
				&nbsp;&nbsp;<input <%=strDisable%> type="checkbox" onclick="fct_onChange()" name="chkCreateService" <%if rscustServ("CREATE_SERVICE_TAG_FLAG")="Y" then response.write "checked"%>> Create Service Tag
			</td>
		</tr>
		<tr>
			...
			<td>
				...
				&nbsp;&nbsp;<input <%=strDisable%> type="checkbox" onclick="fct_onChange()" name="chkDependency" <%if rscustServ("CHECK_SERVICE_DEPENDENCY_FLAG")="Y" then response.write "checked"%>> Check Service Dep
			</td>
		</tr>
		<tr>
			<td align="right" valign="top">Comments&nbsp; </td>
			<td><textarea <%=strDisable%> onchange="fct_onChange()" name="txtComment" style="WIDTH: 100%"><%=routineHTMLString(rscustServ("COMMENTS"))%></textarea></td>
