...
<BODY>
<form name="aifr2" action="<%=ASP_NAME%>" method="POST">
...
<TABLE border=1 cellspacing=0 cellpadding=2 width="100%">
	...
	<tbody>
		...
		if strCustServID <> "" then
			...
			%>
					.WriteLine "<TD NOWRAP>"&routineHTMLString(objRsServiceOrderInfo("SERVICE_CONCENTRATION_NAME"))&"</TD>"
					.WriteLine "<TD NOWRAP>"&routineHTMLString(objRsServiceOrderInfo("SERVICE_BASE_NAME"))&"</TD>"
					.WriteLine "<TD NOWRAP>"&routineHTMLString(objRsServiceOrderInfo("SO_ELEMENT_DESCRIPTION"))&"</TD>"
					.WriteLine "<TD NOWRAP>"&routineHTMLString(objRsServiceOrderInfo("DETAIL_ELEMENT_TEXT"))&"</TD>"
				</tr>
			<%
